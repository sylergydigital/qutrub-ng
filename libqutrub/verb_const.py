...
# Verb Form Constants for the 10 standard Arabic verb forms
FORM_I = 1
FORM_II = 2
FORM_III = 3
FORM_IV = 4
...
# Verb Form Names and Patterns
VERB_FORM_NAMES = {
    FORM_I: u"الفعل المجرد",
    FORM_II: u"فَعَّلَ",
    FORM_III: u"فَاعَلَ",
    FORM_IV: u"أَفْعَلَ",
    FORM_V: u"تَفَعَّلَ",
    FORM_VI: u"تَفاعَلَ",
    FORM_VII: u"اِنْفَعَلَ",
    FORM_VIII: u"اِفْتَعَلَ",
    FORM_IX: u"اِفْعَلَّ",
    FORM_X: u"اِسْتَفْعَلَ"
}
...
VERB_FORM_ENGLISH_MEANINGS = {
    FORM_I: u"Basic/Original",
    FORM_II: u"Intensive/Causative",
    FORM_III: u"Interactive/Reciprocal",
    FORM_IV: u"Causative/Declarative",
    FORM_V: u"Reflexive of Form II",
    FORM_VI: u"Reciprocal of Form III",
    FORM_VII: u"Passive/Reflexive",
    FORM_VIII: u"Reflexive/Participatory",
    FORM_IX: u"Color/Physical Defects",
    FORM_X: u"Request/Seeking"
}
...
VERB_FORM_EXAMPLES = {
    ...
    FORM_V: u"تَكَتَّبَ",
    FORM_VI: u"تَكَاتَبَ",
    FORM_VII: u"اِنْكَتَبَ",
    FORM_VIII: u"اِكْتَتَبَ",
    FORM_IX: u"اِشْوَدَّ",
    FORM_X: u"اِسْتَكْتَبَ"
}

# Form ordering for display
VERB_FORMS_ORDER = [FORM_I, FORM_II, FORM_III, FORM_IV, FORM_V,
